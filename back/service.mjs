...
// FastAPI agentic broker (Tasks 2.5–3.1): proxies agent chat + SSE to cluster vLLM / broker.
const agenticBrokerUrl = (process.env.AGENTIC_BROKER_URL || "http://127.0.0.1:8001").replace(
  /\/$/,
  "",
);
